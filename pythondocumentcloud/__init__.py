...
class DocumentClient(BaseDocumentCloudClient):
    ...
    def search(self, query, page=None, per_page=1000):
        ...
        Example usage:
            ...
            >> documentcloud.documents.search('salazar', page=2, per_page=10)
    ...
    def search_count(self, query):
        ...
        Example usage:
            ...
            >> documentcloud.documents.search_count('salazar')
        """
        result = self._get_search_count(query)
